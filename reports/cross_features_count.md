...
Oldpeak_bin=0 should be combined; there aren't enough examples there. The rest, even though 
there aren't many examples there, are best left alone.
...
- Cholesterol_bin=2, Sex=F, Age_bin=3 & Age_bin=4 (0.4570);
